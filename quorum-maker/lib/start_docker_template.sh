...
PRIVATE_CONFIG=#nodeName#.conf geth --datadir qdata $GLOBAL_ARGS --rpcport 22000 --rpccorsdomain "*" --port 21000 #blockMakerPattern# #voterPattern# --minblocktime 2 --maxblocktime 5 2>qdata/logs/#nodeName#.log &
